 ...
 *
 * The open-visit control leads the line, at the top left of the box.
 *
 * @param {string|null} seen The instant to show.
 * @param {Object}      v    The visit, for the opener and the OPEN mark.
 * @returns {HTMLElement}
 */
 ...
 *
 * Line one is the open-visit control, the instant the visit was last seen and the OPEN mark. Line
 * two is the flag and address, the session time and the bounce, on one line that scrolls sideways
 * when it does not fit. Line
