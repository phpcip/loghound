 ...
 *
 * The values are the ones Loghound's own vocabularies actually contain: the five verdicts the
 * scorer emits, the browser and OS families the User-Agent parser names, the three device
 * classes, the network types the ASN enrichment assigns, and the declared-crawler categories.
 */
const MARKS = {
    bot_verdict_s: {
        ...
        evasive:      ['M8 2.2 14 13H2Z', 'M8 6.4v3.1', 'M8 11.3v.2'],
    ...
    os_s: {
        ...
        iPadOS:    ['M4.4 2.6h7.2a1.2 1.2 0 0 1 1.2 1.2v8.4a1.2 1.2 0 0 1-1.2 1.2H4.4a1.2 1.2 0 0 1-1.2-1.2V3.8a1.2 1.2 0 0 1 1.2-1.2Z', 'M7.4 11.8h1.2'],
    ...
    device_s: {
        ...
        tv:      ['M2.6 4h10.8v6.4H2.6z', 'M5.6 12.4h4.8'],
        _:       ['M3 4.4h10v5.4H3z', 'M5.4 12h5.2', 'M8 9.8V12'],
    },
    ...
    as_type_s: {
        ...
        business: ['M3 5.4h10v7.2H3z', 'M6.2 5.4V3.4h3.6v2'],
        _:       ['M3 3.4h10v3.2H3z', 'M3 9.4h10v3.2H3z'],
    },
    ...
    ua_bot_cat_s: {
        ...
        archive: ['M2.8 4h10.4v2.4H2.8z', 'M4 6.4h8v6.2H4z', 'M6.6 9h2.8'],
    ...
    bot_class_s: {
        ...
        evasive_bot:      ['M8 2.2 14 13H2Z', 'M8 6.4v3.1', 'M8 11.3v.2'],
        unknown:          ['M6 6a2 2 0 1 1 2 2v1.6', 'M8 12.4v.2'],
 ...
 */
const LOUD = {
    bot_verdict_s: ['bot', 'likely_bot', 'evasive'],
    bot_class_s: ['evasive_bot'],
