...
Setup asks one question: **[Opensolr managed] or [my own Solr]**.

Managed path: email + API key → app calls
...
Own-Solr path: base URL + optional HTTP basic auth + core names. Same schema push via the
Config Set API or a documented manual copy.
